...
void Book::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->percentCompleted((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Book::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Book::percentCompleted)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Book::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Book.data,
      qt_meta_data_Book,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void Book::percentCompleted(int _t1)
{
